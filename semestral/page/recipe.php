...
<main class="main-content">
    <form id="recipe-form" action="" method="POST" enctype="multipart/form-data" class="signup-form">
        ...
        <input type="text" id="recipe-name" name="recipe-name" placeholder="Enter the recipe name">
        ...
        <textarea id="howto" name="howto" rows="6" placeholder="Describe how to make the recipe"></textarea>
        <label for="ingredients">Ingredients</label>
        <textarea id="ingredients" name="ingredients" rows="4" placeholder="List the ingredients"></textarea>
